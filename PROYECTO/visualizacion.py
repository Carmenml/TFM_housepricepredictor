...
#para hacer las dos partes de la visualización. NO FUNCIONA YA QUE ES COMPATIBLE A PARTIR DE LA VERSIÓN 1.11.0 Y ESTAMOS EN LA 1.10.0.
...
data = pd.read_csv('datos_finales.csv', index_col = 0)
